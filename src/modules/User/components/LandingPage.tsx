...
function User({ dataTestId }: IUserProps) {
  ...
  return (
    <div data-testid={dataTestId}>
      <div className="max-w-md mb-[20px] flex justify-center">
        <button
          type="button"
          className="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 mb-2"
          onClick={() => fetchData()}
          disabled={loading}
        >
          Refresh
